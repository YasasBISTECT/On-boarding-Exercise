...
namespace On_boarding_API.Controllers
{
    ...
    public class AccountInfoController : ControllerBase
    {
        ...
        [HttpGet("{id:int}")]
        public async Task<ActionResult<AccountInfo>> GetAccountInfo(int custRegisytrationId)
        {
            try
            {
                var result = await accountRepository.GetAccountInfo(custRegisytrationId);
